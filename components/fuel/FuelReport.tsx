  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-bold text-gray-900">주유 리포트</h2>
      ...
      <section className="rounded-xl border border-gray-100 p-3">
        <h3 className="mb-1 text-xs font-bold text-gray-700">월별 주유비</h3>
        ...
        <section className="rounded-xl border border-emerald-100 bg-emerald-50/50 p-3">
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            <div>
              ...
              <div className="mt-0.5 text-sm font-bold text-gray-900">{ev.count}회</div>
            </div>
            <div>
              <div className="text-[11px] text-gray-500">총 충전량</div>
              <div className="mt-0.5 text-sm font-bold text-gray-900">
                {ev.totalKwh > 0 ? `${ev.totalKwh.toLocaleString()}kWh` : '-'}
              </div>
            </div>
            <div>
              <div className="text-[11px] text-gray-500">총 충전비</div>
              <div className="mt-0.5 text-sm font-bold text-gray-900">
